...
以下只展示部分使用到的字段说明，flux-pro-1.1 API 详细字段见[flux-pro-1.1 官网文档](https://docs.bfl.ai/api-reference/models/generate-an-image-with-flux-11-[pro])
...
```bash
curl -X POST "https://api.modelverse.cn/v1/flux-pro-1.1" \
...
url = "https://api.modelverse.cn/v1/flux-pro-1.1"
headers = {
