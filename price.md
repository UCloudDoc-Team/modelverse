...
|            | Qwen/Qwen3-Coder                          | Tokens为单次请求的输入token数：<br>Tokens ≤ 32K：8元<br>32K < Tokens ≤ 128K：9元<br>128K < Tokens ≤ 200K：15元<br><br>Tokens为单次请求的输入token数：<br>Tokens ≤ 32K：24元<br>32K < Tokens ≤ 128K：36元<br>128K < Tokens ≤ 200K：60元 |
...
| 功能 | 模型 | 时长(秒) | 540p价格(元) | 540p耗时(秒) | 720p价格(元) | 720p耗时(秒) | 1080p价格(元) | 1080p耗时(秒) |
|------|------|----------|--------------|--------------|--------------|--------------|---------------|---------------|
| 参考生 | Q2 | 1 | 0.47 | 5.0 | 1.09 | 8.1 | 2.34 | 9.9 |
| 参考生 | Q2 | 2 | 0.63 | 6.6 | 1.25 | 12.4 | 2.66 | 15.7 |
| 参考生 | Q2 | 3 | 0.78 | 8.4 | 1.41 | 16.3 | 2.97 | 20.4 |
| 参考生 | Q2 | 4 | 0.94 | 11.0 | 1.56 | 22.3 | 3.28 | 27.1 |
| 参考生 | Q2 | 5 | 1.09 | 14.7 | 1.72 | 28.7 | 3.59 | 35.3 |
| 参考生 | Q2 | 6 | 1.25 | 16.5 | 1.88 | 34.9 | 3.91 | 44.1 |
| 参考生 | Q2 | 7 | 1.41 | 18.7 | 2.03 | 41.2 | 4.22 | 53.0 |
| 参考生 | Q2 | 8 | 1.56 | 22.1 | 2.19 | 49.5 | 4.53 | 62.9 |
